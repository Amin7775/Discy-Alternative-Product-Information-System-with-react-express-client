...
const UserDetails = ({ query }) => {
  ...
  return (
    <div className="bg-white px-6 md:px-10 py-8  rounded-md drop-shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 text-center mt-2 md:mt-3 lg:mt-4">
        <div className="flex gap-1 px-3 py-2 border bg-page_bg drop-shadow-sm   justify-center">
