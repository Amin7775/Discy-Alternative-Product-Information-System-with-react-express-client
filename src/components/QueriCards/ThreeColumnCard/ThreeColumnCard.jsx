...
const ThreeColumnCard = ({ query }) => {
    const {
      ...
      return (
        <div className="bg-white px-3 md:px-4 lg:px-7 py-4 lg:py-8 flex flex-col-reverse gap-6 rounded-md drop-shadow-sm h-full">
          <div className="w-full flex-grow flex flex-col justify-between">
            <div>
              ...
              <div className="my-2 text-custom_Dark flex flex-col gap-1.5">
                ...
                {/* query title */}
                <h1 className="text-sm md:text-xl lg:text-2xl font-medium mt-1 mb-1 md:mb-2 ">{queryTitle}</h1>
                {/* <h3 className="font-medium  text-gray-600">Product Details - </h3> */}
    
                <h3 className="text-xs text-wrap md:text-base font-medium text-gray-600">
                ...
                <p className="text-xs text-wrap md:text-base font-medium text-gray-500">{boycottingReason}</p>
              </div>
            </div>
            {/* recommendation box */}
            <div className="bg-page_bg py-5 px-3 md:p-5 flex flex-col md:justify-between mt-5 items-center gap-3">
